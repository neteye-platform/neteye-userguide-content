...
It is also possible to specify other GLPI Entities as the main entity for the tenant master role.
If you're planning to utilize multiple tenants in the future, we do not recommended overriding the
...
To start collecting assets, you can choose to run in either agent-based or agentless configuration.
