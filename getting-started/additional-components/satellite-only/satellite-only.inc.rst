...
correctly installed on the Master following the :ref:`Single Node <neteye-module-install-single-node>` or
:ref:`Cluster Node <neteye-module-install-cluster-node>` installation depending on your configuration.
