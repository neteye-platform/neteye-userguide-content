...
You can do this by going to **Configuration > Modules > monitoring > Security**
(:numref:`figure-protecting-credentials`) and setting a
pattern that will hide the values for all fields derived from custom
variables where those fields’ names match the pattern. This pattern
goes in the field “Protected Custom Variables”, where the syntax is
`defined by Icinga
<https://icinga.com/docs/icingaweb2/latest/modules/monitoring/doc/03-Configuration/#security-configuration>`_.
