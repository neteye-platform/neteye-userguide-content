...
to update the SATAYO Findings. In the settings you can set up an e-mail or telegram notification
...
The findings are divided into three major categories called **INFRASTRUCTURE**, **DATA FILES & PEOPLE** and **DEEP & DARK WEB**.
...
Scan times by type of Findings
------------------------------

The following table lists the details of how often each scan is performed according to the type of finding. All the evidence is described in details in the page :ref:`SATAYO Findings<satayo_findings>`.
