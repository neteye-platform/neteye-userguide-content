...
SOC System Administrator (AdS)
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

System Administrators play a critical role in data security and network management,
with privileged access to corporate and institutional information.

The Data Protection Authority requires organizations to enhance supervision of System Administrators
with specific technical and organizational measures:

 - **Access Logging**: All System Administrator access to systems and electronic archives must be recorded,
   including timestamps and event descriptions. Logs must be retained for at least six months.
...
The retention period for this specific offer is 180 days.
