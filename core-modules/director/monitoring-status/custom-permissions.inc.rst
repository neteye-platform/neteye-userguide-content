...
permissions in the **Monitoring** module; a Role with *General Access
Module* usually suffices for this purpose.
...
-  **Quick Actions**: It is a monitoring module permission that can be
   used to hide complete or specific command with the
   ``monitoring/command/*`` permission. This Quick Actions section has
