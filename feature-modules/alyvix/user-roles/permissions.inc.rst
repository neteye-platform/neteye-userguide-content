...
the user needs to have permissions to see them in the `Monitoring` module.

.. image:: /feature-modules/alyvix/img/alyvix-super-admin-permissions.png
  :width: 49 %
.. image:: /feature-modules/alyvix/img/alyvix-monitoring-permissions.png
  :width: 49 %
...
#. Enable the **General Module Access** for the Monitoring (possibly restricting the hosts visible by the user)
