...
To integrate the VMD information into the Monitoring module, navigate to
:menuselection:`VMD / Configuration / Monitoring` and then add a new integration
by clicking the :guilabel:`Add` button.

Configure the parameters related to your vCenter and Monitoring backend (**IDO Resource** and
