...
or to a USB stick, then turn the server on and follow the instructions
in the next sections to install a :ref:`Single Node and Satellite
<single-node-install>` or a :ref:`Cluster Node <cluster-node-install>`.
In case of a Satellite, follow the additional instructions in Section
...
#. Before starting your new VM, look at the list of startup media in
