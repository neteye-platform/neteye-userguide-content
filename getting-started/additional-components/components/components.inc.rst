...
check the advice in :ref:`safe-command-execution` then follow the
procedure for either a :ref:`neteye-module-install-single-node` or
:ref:`neteye-module-install-cluster-node`.
