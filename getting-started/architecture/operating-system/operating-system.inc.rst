...
Since release of NetEye 4.23, we build our product on top of **Red Hat Enterprise Linux 8**
...
packages will still get high priority security and bug fixes, however no minor version
upgrades or enhancements. The Maintenance Support Phase is projected to end on **May 31, 2029**.

The last phase is the **Extended Life Phase**. In this phase, Red Hat provides no longer updated
...
Insights <https://www.redhat.com/en/technologies/management/insights>`_, which allows us a quick
