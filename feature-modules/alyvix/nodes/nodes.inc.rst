...
* **Live preview**: A visual preview of the session generated from screenshots captured periodically,
  ...
  expected and to monitor the execution of test cases in near real time.

  .. note:: The screenshot settings for both the thumbnail and the expanded live preview, including
    frame interval, resolution, quality and format, can be customized in the configuration file
