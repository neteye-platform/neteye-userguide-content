...
assigned to a ``Host Template``. Refer to :ref:`Working with fields
<director-working-fields>` section to setup a data field. You also
...
.. figure::  /core-modules/director/img/monitored-services.png
   :alt: Dashboard - Monitored services

   Dashboard - Monitored services

Then create a new ``Service template`` with check command ``tcp``:

.. figure::  /core-modules/director/img/add-service-template.png
   :alt: Define service template - tcp

   Define service template - tcp

Then associate the data field ``tcp_port`` to this ``Service template``:

.. figure::  /core-modules/director/img/add-service-template-field.png
   :alt: Associate field to service template - tcp_port

   Associate field to service template - tcp_port

Then create a new ``apply-rule`` for the ``Service template``:

.. figure::  /core-modules/director/img/create-apply-rule.png
   :alt: Define apply rule
...
.. figure::  /core-modules/director/img/configure-apply-for.png
