...
self-contained server.  Single Node is the basic variant of |ne|
...
environment, consider adopting a :ref:`Cluster
<neteye-cluster-architecture>` setup.

To start monitoring on a Single Node you only need to :ref:`install
...
tenants to monitor simultaneously. To achieve the latter,
your environment might use Satellite nodes as actors that
help communicate data to the Master.

A Satellite Node should be :ref:`set up
...
.. figure:: /getting-started/architecture/img/architecture-single-node.jpg
